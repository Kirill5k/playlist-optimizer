...
class SpotifyPlaylistControllerSpec extends ControllerSpec {
  ...
  val optimization = Optimization(optimizationId, BigDecimal(0), optimizationParameters, shortenedPlaylist, Instant.parse("2020-01-01T00:00:00Z"))
  ...
  "A SpotifyPlaylistController" should {
    ...
    "GET /playlists - get all playlists" in {
      ...
      val expected = List(PlaylistView(
        ...
        List(TrackView("Glue", List("Bicep"), PlaylistBuilder.defaultRelease, None, 129.983, 269.15, 5, 0, 0.613,0.807, "spotify:track:2aJDlirz6v2a4HREki98cP", Some("https://open.spotify.com/track/2aJDlirz6v2a4HREki98cP"))),
        "Spotify"
      ))
